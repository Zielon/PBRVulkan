...
namespace Vulkan
{
	...
	public:
		...
		static void SubmitCompute(const CommandPool& commandPool, const std::function<void(VkCommandBuffer)>& func)
		{
			VkCommandBufferAllocateInfo allocInfo{};
			allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
			allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
			...
			auto* const computeQueue = commandPool.GetDevice().ComputeQueue;
